...
void testAddRepo()
{
	...
	Produs produs1(1,nume1, pret1, nr_ex1);

	strcpy_s(nume2, sizeof "iaurt", "iaurt");
	Produs produs2(2,nume2, pret2, nr_ex2);
...
void testRemoveRepo()
{
	...
	Produs produs3(3,nume3, pret3, nr_ex3);

	strcpy_s(nume4, sizeof "rosii", "rosii");
	Produs produs4(4,nume4, pret4, nr_ex4);
...
void testUpdateRepo()   /// se testeaza aici si service-ul
{
	...
	Service serv;
	serv.updateProdus(3, nume3, pret3, nr_ex3, nume4, pret4, nr_ex4);
...
void testCumparaProdus()
{
	...
	Service service;
	assert(service.cumparaProdus(3, nume3, nr_ex3)==1);
...
void testReturneazaProdus()
{
	...
	Service service;
	assert(service.returneazaProdus(3, nume3, 1) == 2);
