...
void Service::addProdus(char* nume, int pret, int nr_exemplare)
{
	...
	this->repo.addProdus(Produs(id, nume, pret, nr_exemplare)); //am adaugat id
}

void Service::updateProdus(int id, char* numeVechi, int pretVechi, int nr_exemplareVechi, char* nume, int pret, int nr_exemplare)
{
	Produs p = { id, nume, pret, nr_exemplare }; //am adaugat id
	Produs pVechi = { id, numeVechi, pretVechi, nr_exemplareVechi }; //am adaugat id
